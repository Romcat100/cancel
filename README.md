...
| **Fadeout** (`∿…`) | Last signal standing. Each turn the player who scores the least fades out and scores nothing for the rest of the round. Tied and cancelled cards count as scoring zero. Faded players still play, and their cards still tie and cancel the living. If everyone left comes out even (a full tie, or a board wiped by a lone `0`), nobody fades. The last player left in the mix earns +2 per faded rival. |
