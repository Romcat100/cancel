...
// Number-pick randomness. Rather than always playing the highest-EV card (which made every bot
// march 5,4,3,2 down its hand and tie the others, since identical hands produce identical argmaxes),
// a bot SAMPLES a card with probability ∝ (EV + floor)^GREED. Independent draws spread bots across
// the hand, so they rarely converge on the same card. GREED tunes greedy↔random: 1 is roughly
